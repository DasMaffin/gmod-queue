...
TARGET = $(TARGETDIR)/gmsv_queueQueueServer_linux.dll
OBJDIR = x86/ReleaseWithSymbols/intermediate/gmsv_queueQueueServer
DEFINES += -DNDEBUG -DGMMODULE -DQUEUEQUEUESERVER_SERVER -DIS_SERVERSIDE=true -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DGMOD_MODULE_NAME=\"queueQueueServer\" -DGAME_DLL -DRAD_TELEMETRY_DISABLED -DGMOD_USE_SOURCESDK -DCOMPILER_GCC -DPOSIX -D_POSIX -DLINUX -D_LINUX -DGNUC -DNO_MALLOC_OVERRIDE
...
ALL_LDFLAGS += $(LDFLAGS) -L../../../garrysmod_common/sourcesdk-minimal/lib/public/linux32 -L/usr/lib32 -m32 -shared -Wl,-soname=gmsv_queueQueueServer_linux.dll -Wl,--no-undefined

else ifeq ($(config),release_x86)
TARGETDIR = x86/Release
TARGET = $(TARGETDIR)/gmsv_queueQueueServer_linux.dll
OBJDIR = x86/Release/intermediate/gmsv_queueQueueServer
DEFINES += -DNDEBUG -DGMMODULE -DQUEUEQUEUESERVER_SERVER -DIS_SERVERSIDE=true -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DGMOD_MODULE_NAME=\"queueQueueServer\" -DGAME_DLL -DRAD_TELEMETRY_DISABLED -DGMOD_USE_SOURCESDK -DCOMPILER_GCC -DPOSIX -D_POSIX -DLINUX -D_LINUX -DGNUC -DNO_MALLOC_OVERRIDE
...
ALL_LDFLAGS += $(LDFLAGS) -L../../../garrysmod_common/sourcesdk-minimal/lib/public/linux32 -L/usr/lib32 -m32 -flto -shared -Wl,-soname=gmsv_queueQueueServer_linux.dll -s -Wl,--no-undefined

else ifeq ($(config),debug_x86)
TARGETDIR = x86/Debug
TARGET = $(TARGETDIR)/gmsv_queueQueueServer_linux.dll
OBJDIR = x86/Debug/intermediate/gmsv_queueQueueServer
DEFINES += -DDEBUG -D_DEBUG -DGMMODULE -DQUEUEQUEUESERVER_SERVER -DIS_SERVERSIDE=true -DGMOD_ALLOW_OLD_TYPES -DGMOD_ALLOW_LIGHTUSERDATA -DGMOD_MODULE_NAME=\"queueQueueServer\" -DGAME_DLL -DRAD_TELEMETRY_DISABLED -DGMOD_USE_SOURCESDK -DCOMPILER_GCC -DPOSIX -D_POSIX -DLINUX -D_LINUX -DGNUC -DNO_MALLOC_OVERRIDE
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking gmsv_queueQueueServer
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning gmsv_queueQueueServer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
